package org.snakes.gui;

import org.snakes.domain.Conus;
import org.snakes.service.SnakeEngine;
...
public class MyGUI extends JFrame {
    ...
    public Board panel = new Board();
    public Pane pane = new Pane();
    JScrollPane scrollerP = new JScrollPane(pane);
    public JButton button = new JButton("Бросить кубик");
    JLabel pic = new JLabel();
    ButtonGroup group = new ButtonGroup();
    public JRadioButton withHuman = new JRadioButton("С человеком");
//    JRadioButton withPC = new JRadioButton("С компьютером");
    public JRadioButton with100Button = new JRadioButton("Игра строго до 100");
    public JRadioButton without100Button = new JRadioButton("Игра до/больше 100");
    ButtonGroup group1 = new ButtonGroup();
    ButtonGroup group2 = new ButtonGroup();
    JRadioButton withVCube = new JRadioButton("С вирт. кубиком");
    public JRadioButton withRCube = new JRadioButton("С реальным кубиком");
...
//        withPC.setEnabled(false);
    ...
    public class Board extends JPanel {
        ...
        public Board() {
            try {
                image = ImageIO.read(getClass().getClassLoader().getResource("snake.jpg"));
                conus1 = ImageIO.read(getClass().getClassLoader().getResource("conus1.png"));
                conus2 = ImageIO.read(getClass().getClassLoader().getResource("conus2.png"));
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
